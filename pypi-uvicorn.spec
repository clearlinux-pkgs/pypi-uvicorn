...
Source0  : https://files.pythonhosted.org/packages/b3/c7/210ee32ac2ab2017dfd914c189d9f78c2d9250626048efce3d9810e54da5/uvicorn-0.30.4.tar.gz
...
%prep
%setup -q -n uvicorn-0.30.4
cd %{_builddir}/uvicorn-0.30.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722527696
