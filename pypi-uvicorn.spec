...
Source0  : https://files.pythonhosted.org/packages/77/40/b650be95700dc83d14c5f2b9eac9deb23cbca757a12ee20e473b5ef1ac48/uvicorn-0.30.3.tar.gz
...
%prep
%setup -q -n uvicorn-0.30.3
cd %{_builddir}/uvicorn-0.30.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721665377
